...
PLUGIN_NAME = LottoDE
PACKAGE_NAME = enigma2-plugin-extensions-lottode
...
LOCALE_DE_PO = $(LOCALE_DE_DIR)/de.po
LOCALE_DE_PYI18N = $(LOCALE_DE_DIR)/de.mo

.PHONY: compile-locales all build clean normalize compile-locale prepare ipk install restart deploy
